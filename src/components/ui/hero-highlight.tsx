...
/**
 * Aceternity UI's HeroHighlight — recolored to our orange accent and adapted
 * for our dark theme. Dots reveal under the cursor inside a 200px radial mask.
 */
...
/**
 * Inline animated highlight on a text span. Animates a colored background from
 * 0% to 100% on mount, then stays. Used to draw the eye to a single key word.
 */
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        "relative inline-block rounded-md bg-gradient-to-r from-accent/40 to-accent-hover/40 px-1 pb-1",
        className,
      )}
    >
      {children}
