      ...
      {SECTIONS.map((s, i) => (
        <Section
          ...
          mediaWrapperClassName={
            ...
            i === 1
              ? "absolute inset-y-[8vh] left-[4vw] hidden md:flex md:w-[55%] items-center pointer-events-auto"
              : i === 3
              ? "absolute inset-y-[8vh] right-[4vw] hidden md:flex md:w-[55%] items-center pointer-events-auto"
              : undefined
          }
        />
      ))}
