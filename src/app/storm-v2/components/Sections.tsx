...
/**
 * Mid-page sections, in KPost skeleton order:
 * credibility wall → six service cards → territory band → crew story →
 * storm-damage urgency band. All copy/data lives in ./data.
 */
    ...
    <section className="mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-32">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 md:mt-16">
        {SERVICES.map((s, i) => (
          ...
          >
            <div className={`${styles.cardArt} flex h-28 items-center justify-center`}>
              <Icon name={s.icon} className="h-12 w-12 text-accent" />
            </div>
...
/* ---------------------------------------------------------------- */
/* 4 · Territory band (diagonal)                                     */
/* ---------------------------------------------------------------- */

export function Territory() {
  return (
    <section className={`${styles.band} my-12 py-20 md:py-28`}>
...
/* ---------------------------------------------------------------- */
/* 5 · Crew story + storm-response record                            */
/* ---------------------------------------------------------------- */
...
/* ---------------------------------------------------------------- */
/* 6 · Storm-damage urgency band (diagonal, darker)                  */
/* ---------------------------------------------------------------- */
...
export function StormDamage() {
  return (
    <section className={`${styles.band} ${styles.bandDark} my-12 py-20 md:py-28`}>
      <div className="mx-auto max-w-6xl px-6 md:px-8">
        <SectionHeading
